...
if (isset($_POST['edit_task'])) {//echo 123;exit();
    ...
    $query = "UPDATE tasks SET uid = ?, department_id = ?, title= '".$_POST['title']."', description = ?, start_date = ?, end_date = ? WHERE tid = ?";
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_param($stmt, "iisssi", $uid, $department_id, $description, $start_date, $end_date, $task_id);
//echo $stmt;exit();  
        ...
        if (!empty($comments)) {
            ...
            mysqli_stmt_bind_param($comment_stmt, "iiss", $task_id, $admin_id, $comments,$from_type);
            ...
            while ($row = mysqli_fetch_assoc($query_run)) {
                ...
                <form action="" method="post" enctype="multipart/form-data" class="mb-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id" id="userSelect" required>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#departmentSelect').change(function() {
                ...
                if (departmentId != '') {
                    $.ajax({
                        url: 'fetch_department_users.php',
                        method: 'POST',
