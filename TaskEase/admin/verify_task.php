...
<body>
    <center><h3>Approve Assigned Tasks</h3></center><br>
    <table class="table" style="background-color: whitesmoke; width: 75vw;">
        ...
        <?php
            $sno = 1;
            $query = "SELECT * FROM tasks WHERE status = 'Complete' or status='Approved'";
                ...
                <tr class="<?php echo $isApproved ? 'approved-task' : ''; ?>">
                    ...
                    <td>
                        ...
                        <?php if (!$isApproved) { ?>
                            ...
                            <a href="approve_task.php?id=<?php echo $row['tid']; ?>">Approve</a> |
                        <?php } ?>
    ...
    <div id="attachmentsModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="attachmentsModalLabel"></h5>
            ...
            $('.view-files').click(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#attachmentsModalLabel").html("Task Attachments")
                        $('#modalBody').html(data);
